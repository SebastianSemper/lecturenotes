...
Betrachten wir aber nun $n$ viele solcher \emph{unabhängiger} Laplaceexperimente $X_1, \ldots X_n$ und zählen die Anzahl der Erfolge $X$ in diesen $n$ Experimenten, also 
\[
    X = \Sum{i = 1}{n}{X_n},
\]
