...
%
%
\paragraph{Diskrete Verteilungen}
%
...
\paragraph{Charakteristische Funktion} Gegeben eine Zufallsgröße $X$ mit Dichte $f_X$, ist die zugehörige \emph{charakteristische Funktion} $\phi_X : \R \rightarrow \C$ definiert durch
\begin{equation}
...
\begin{listing}[ht]
    ...
    \begin{minipage}{0.51\textwidth}
        \strut\vspace*{-\baselineskip}\newline
        \inputminted[firstline=5, lastline=6]{python3}{code/random/signal1.py}
    \end{minipage}%
    \begin{minipage}{0.48\textwidth}
        \strut\vspace*{-\baselineskip}\newline
...
\begin{listing}[ht]
    ...
    \begin{minipage}{0.51\textwidth}
        \strut\vspace*{-\baselineskip}\newline
        \inputminted[firstline=5, lastline=17]{python3}{code/random/signal2.py}
    \end{minipage}%
    \begin{minipage}{0.48\textwidth}
        \strut\vspace*{-\baselineskip}\newline
...
\begin{listing}[ht]
    ...
    \begin{minipage}{0.51\textwidth}
        \strut\vspace*{-\baselineskip}\newline
        \inputminted[firstline=6, lastline=19]{python3}{code/random/signal3.py}
    \end{minipage}%
    \begin{minipage}{0.48\textwidth}
        \strut\vspace*{-\baselineskip}\newline
        \includegraphics[width=\textwidth]{code/random/signal3.png}
    \end{minipage}
    \codecaption{dsv/code/random/signal3.py}{Visualisierung der Dichte der Normalverteilung für verschiedene Parameter}\label{py:random:signal3}
\end{listing}

Wir zeigen in \Cref{py:random:signal3}, wie man aus mehreren Realisierungen eines stationären Signals
\[
x[n] = X_n = \sin(2 \pi 5 n \Delta t + \phi) + z_n,
\]
wobei $z_n \sim \mathcal{N}(0, 0.3^2)$ und $\phi \sim \Unif(0, 2\pi)$ \gls{iid}.
...
Wir sehen, dass die Histogramme in etwa übereinstimmen, also können wir von Stationarität ausgehen.
