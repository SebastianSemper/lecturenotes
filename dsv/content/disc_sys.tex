...
Kleine Ver"anderungen an $x[n] = c$ haben gro"sen Einfluss auf das Divergenzverhalten der Folge $y[n]$\externallink{{https://erleuchtet.org/2010/07/ridiculously-large-buddhabrot.html}}.
\begin{listing}
    \noindent
    \begin{minipage}{0.49\textwidth}
        \strut\vspace*{-\baselineskip}\newline
...
Man nimmt also Fehler in der Analyse in Kauf\externallink{{https://en.wikipedia.org/wiki/Hartman-Grobman_theorem}}, ist damit aber immerhin in der Lage "uberhaupt Aussagen treffen zu k"onnen.
%