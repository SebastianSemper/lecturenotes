...
\end{equation}
auch wieder ein Parseval Theorem f"ur die \acrlong{ft} ergibt, was aber in diesem Fall als Plancherel Theorem\linkfootnote{{https://en.wikipedia.org/wiki/Plancherel_theorem}} genannt wird.
...
Diesen Effekt bezeichnet man allgemein als Gibbssches Ph"anomen\linkfootnote{{https://en.wikipedia.org/wiki/Gibbs_phenomenon}}.
