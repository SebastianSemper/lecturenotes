...
\end{equation}
%
als den \emph{Satz von Parseval}\externallink{{https://de.wikipedia.org/wiki/Satz\_von\_Parseval}} zu erhalten.
...
\end{equation}
auch wieder ein Parseval Theorem f"ur die \acrlong{ft} ergibt, was aber in diesem Fall als Plancherel Theorem\externallink{{https://en.wikipedia.org/wiki/Plancherel_theorem}} genannt wird.
...
Diesen Effekt bezeichnet man allgemein als Gibbssches Ph"anomen\externallink{{https://en.wikipedia.org/wiki/Gibbs_phenomenon}}.
