...
\newacronym{agv}{AGV}{Automated Guided Vehicels}
...
\newacronym{af}{AF}{Ambiguity Function}
...
\newacronym{btp}{BTP}{Bistatic Target Path}
...
\newacronym{cam}{CAM}{Cooperative Awareness Messages}
...
\newacronym{dbs}{DBS}{Distributed Base Station}
...
\newacronym{ems}{FG EMS}{Fachgebiet Elektronische Messtechnik und Signalverarbeitung}
\newacronym{etof}{eToF}{Excess Time of Flight}
\newacronym{etoa}{eToA}{Excess Time of Arrival}
\newacronym{evv}{eVV}{Excess Velocity vector}
...
\newacronym{frf}{FRF}{Frequency Response Functions}
...
\newacronym{pbdl}{PBDL}{Physics Based Deep Learning}
...
\newacronym{roc}{ROC}{Region of Convergence}
\newacronym{rt}{RT}{Raytracing}
\newacronym{rimax}{RIMAX}{Richter Maximization Approach}
\glsunset{rimax}
\newacronym{rvm}{RVM}{Relevance Vector Machine}
\newacronym{rss}{RSS}{Received Signal Strength}
\newacronym{rfid}{RFID}{Radio Frequency Identification}
\newacronym{refodat}{REFODAT}{Repositorium für Forschungsdaten in Thüringen}
...
\newacronym{sfu}{SFU}{Specifal Function Unit}
...
\newacronym{sl}{SL}{Side Link}
\newacronym{sf}{SF}{Scattering Function}
...
\newacronym{udc}{UDC}{Up/Down Converter}

\newacronym{vna}{VNA}{Vector Network Analyser}
\newacronym{vsh}{VSH}{Vector Spherical Harmonics}
\hyphenation{op-tical}
\hyphenation{net-works}
\hyphenation{semi-con-duc-tor}
\hyphenation{Ex-pec-ta-tion}
\hyphenation{Tap-kon-fi-gu-ra-tion}
